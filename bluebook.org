...
languages.  Putting this all together, it's possible that
this iteration of technological disruption is fundamentally
different from all the others.  This is not an iterative
progression, it is a qualitative systematic leap that brings
together a wide range of advances that result in a
fundemental transformation in human culture and society.
